...
//             background:#ffffff;
//         ">
//             <div style="font-size:11px;color:#64748b;margin-bottom:4px;font-weight:500;text-transform:uppercase;letter-spacing:0.4px;">
//                 ${label}
//             </div>
//             <div style="font-size:13px;color:#111827;word-break:break-word;">
//                 ${value || "-"}
//             </div>
//         </div>
//     `;
...
//                 </div>
//                 <div style="margin-top:4px;color:#64748b;font-size:13px;">Prospect CRM Dashboard</div>
//             </div>
...
//         const isDomestic = lead.custom_sales_type === "Domestic / Merchant";

//         const l0Fields = isDomestic ? `
...
//             ${prospect_summary_item("Type of Buyer", lead.custom_buyer_type || lead.custom_type_of_buyer)}
...
//             ${prospect_summary_item("Website", lead.custom_website_a ? "Yes" : "No")}
//             ${prospect_summary_item("LinkedIn", lead.custom_linkedin ? "Yes" : "No")}
...
//             ${prospect_summary_item("Requirement (MTPA)", lead.custom_tentative_requirement_mtpa)}
...
//             ${prospect_summary_item("Status", lead.custom_export_lead_status)}
//         ` : `
...
//                             ${lead.name}
//                         </a>
//                         <div style="color:#64748b;margin-top:3px;font-size:13px;">
//                             ${lead.company_name || lead.custom_first_name_s || lead.custom_namee_of_the_company || ""}
//                         </div>
//                     </div>
//                     <span style="
...
//                     ">
//                         ${lead.custom_export_lead_status }
//                     </span>
//                 </div>
...
//                         padding:7px 20px;border-radius:8px 8px 0 0;border:1px solid #e2e8f0;
//                         border-bottom:none;background:#2563eb;color:#fff;font-weight:600;
//                         cursor:pointer;font-size:13px;
//                     ">L0</button>
//                     <button class="lead-section-tab btn btn-sm" data-section="l1" style="
//                         padding:7px 20px;border-radius:8px 8px 0 0;border:1px solid #e2e8f0;
//                         border-bottom:none;background:#f8fafc;color:#334155;font-weight:600;
//                         cursor:pointer;font-size:13px;
//                     ">L1</button>
...
//             $("#crm-lead-detail .lead-section-tab").css({
//                 background: "#f8fafc",
//                 color: "#334155"
//             });
...
// ─────────────────────────────────────────────
function prospect_summary_item(label, value) {
    // Skip card entirely if no value
...
async function render_prospect_top_summary(frm) {
    ...
    function renderLeadDetail(lead, activeTab) {
        ...
        $("#crm-lead-detail").off("click", ".lead-section-tab").on("click", ".lead-section-tab", function() {
            ...
            $("#crm-lead-detail .lead-section-tab").css({ background: "#f8fafc", color: "#334155" });
            $(this).css({ background: "#2563eb", color: "#fff" });
            $(".lead-section-panel").hide();
            $("#panel-" + section).css("display", "grid");
        });
        ...
        if (activeTab !== "l0") {
            ...
            $("#crm-lead-detail .lead-section-tab[data-section='l0']")
                .css({ background: "#f8fafc", color: "#334155" });
            $(".lead-section-panel").hide();
